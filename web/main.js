...
var _hoisted_1$5 = ["data-p-checked", "data-p-indeterminate", "data-p-disabled", "data-p"];
...
function render$8(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  })], 16, _hoisted_3$1)], 16, _hoisted_1$5);
}
...
var _hoisted_1$4 = ["aria-label", "data-p"];
...
function render$6(_ctx, _cache, $props, $setup, $data, $options) {
  ...
  }) : createCommentVNode("", true)], 16, _hoisted_1$4)) : createCommentVNode("", true);
}
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createBlock(unref(script), {
        ...
        loadingicon: withCtx(() => [
          createVNode(unref(script$f), { class: "animate-spin" })
        ]),
        filtericon: withCtx(() => [
          createVNode(unref(script$g), { class: "text-surface-400" })
        ]),
...
const PromptWidget = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-5ebb2552"]]);
